        ...
        <div class="container">
            <div class="slider-container">
                <div class="intro-text">
                    ...
                    <div class="intro-heading">O melhor site de Avengers</div>
                    <a href="#about" class="page-scroll btn btn-xl">Sobre os Avergers</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <section id="portfolio" class="light-bg">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="ot-portfolio-item">
                    <figure class="effect-bubba">
                        <img src="<?php base_url();?>public/images/demo/portfolio-1.jpg" alt="img02" class="img-responsive" />
                        <figcaption>
                            <h2>Dean & Letter</h2>
                            <p>Branding, Design</p>
            ...
            <div class="col-md-4">
                <div class="ot-portfolio-item">
                    <figure class="effect-bubba">
                        <img src="<?php base_url();?>public/images/demo/portfolio-2.jpg" alt="img02" class="img-responsive" />
                        <figcaption>
            ...
            <div class="col-md-4">
                <div class="ot-portfolio-item">
                    <figure class="effect-bubba">
                        <img src="<?php base_url();?>public/images/demo/portfolio-3.jpg" alt="img02" class="img-responsive" />
                        <figcaption>
                            <h2>Lamp & Velvet</h2>
                            <p>Branding, Web Design</p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="ot-portfolio-item">
                    <figure class="effect-bubba">
                        <img src="<?php base_url();?>public/images/demo/portfolio-4.jpg" alt="img02" class="img-responsive" />
                        <figcaption>
                            <h2>Smart Name</h2>
                            <p>Branding, Design</p>
            ...
            <div class="col-md-4">
                <div class="ot-portfolio-item">
                    <figure class="effect-bubba">
                        <img src="<?php base_url();?>public/images/demo/portfolio-5.jpg" alt="img02" class="img-responsive" />
                        <figcaption>
                            <h2>Fast People</h2>
                            <p>Branding, Web Design</p>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="owl-carousel">
                        <div class="item">
                            <div class="partner-logo"><img src="<?php base_url();?>public/images/demo/partners-1.png" alt="partners"></div>
                        </div>
                        <div class="item">
                            <div class="partner-logo"><img src="<?php base_url();?>public/images/demo/partners-2.png" alt="partners"></div>
                        </div>
                        <div class="item">
                            <div class="partner-logo"><img src="<?php base_url();?>public/images/demo/partners-3.png" alt="partners"></div>
                        </div>
                        <div class="item">
                            <div class="partner-logo"><img src="<?php base_url();?>public/images/demo/partners-4.png" alt="partners"></div>
                        </div>
                        <div class="item">
                            <div class="partner-logo"><img src="<?php base_url();?>public/images/demo/partners-5.png" alt="partners"></div>
                        </div>
                        <div class="item">
                            <div class="partner-logo"><img src="<?php base_url();?>public/images/demo/partners-6.png" alt="partners"></div>
                        </div>
                        <div class="item">
                            <div class="partner-logo"><img src="<?php base_url();?>public/images/demo/partners-7.png" alt="partners"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="team-item">
                        <div class="team-image">
                            <img src="<?php base_url();?>public/images/demo/author-2.jpg" class="img-responsive" alt="author">
                        </div>
                        <div class="team-text">
                            <h3>TOM BEKERS</h3>
                ...
                <div class="col-md-3">
                    <div class="team-item">
                        <div class="team-image">
                            <img src="<?php base_url();?>public/images/demo/author-6.jpg" class="img-responsive" alt="author">
                        </div>
                        <div class="team-text">
                            <h3>LINA GOSATA</h3>
                ...
                <div class="col-md-3">
                    <div class="team-item">
                        <div class="team-image">
                            <img src="<?php base_url();?>public/images/demo/author-3.jpg" class="img-responsive" alt="author">
                        </div>
                        <div class="team-text">
                            <h3>Larry Parker</h3>
                ...
                <div class="col-md-3">
                    <div class="team-item">
                        <div class="team-image">
                            <img src="<?php base_url();?>public/images/demo/author-4.jpg" class="img-responsive" alt="author">
                        </div>
                        <div class="team-text">
                            <h3>John BEKERS</h3>
